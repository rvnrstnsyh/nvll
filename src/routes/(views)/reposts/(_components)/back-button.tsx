...
export default function BackButton({ title, href }: BackButtonProps): JSX.Element {
	return (
		<div className='flex items-center justify-between pb-[44px]'>
			<a href={href} className='anchor-text flex items-center justify-center gap-1 text-sm mt-1'>
				<svg className='inline-block w-5 h-5' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'>
					<path
